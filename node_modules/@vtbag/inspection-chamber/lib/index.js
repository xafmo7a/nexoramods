...
" src=${nt} alt="Reactivate the inspection chamber" /><div>
		...
		<style>
			...
			`),$t()}function $t(){let t=top.document.querySelector("#vtbag-ui-reopen"),e={x:-1,y:-1},n={x:-1,y:-1};t.addEventListener("click",o),t.addEventListener("touchend",o),T(t,(i,a)=>{t.style.left=`${i}px`,t.style.top=`${a}px`,e={x:i,y:a},_t(t)},(i,a)=>(e={x:-1,y:-1},n={x:i,y:a}));function o(){(e.x===-1||Math.pow(n.x-e.x,2)+Math.pow(n.y-e.y,2)<=16)&&(top.sessionStorage.removeItem(k),top.location.reload())}}function _t(t){top.sessionStorage.setItem(it,JSON.stringify({reopenerLeft:t.style.left,reopenerTop:t.style.top}))}var b=()=>top.document.documentElement.classList.contains("vtbag-vt-active"),at=()=>top.document.documentElement.classList.add("vtbag-vt-active"),rt=()=>top.document.documentElement.classList.remove("vtbag-vt-active"),W,P;function h(t,e,n=!1){let o=b();n||o||W||!top.document.startViewTransition?(!1,t()):(P=e,W=top.document.startViewTransition(t),W.finished.finally(()=>W=P=void 0))}function Z(){top.__vtbag.inspectionChamber.viewTransition?.skipTransition()}var Y=2,te=5,m;function gt(){dt(),t(),top.document.querySelector("#vtbag-ui-light-dark").addEventListener("click",t);function t(){let n=top.document.documentElement.style.colorScheme.startsWith("dark");m.innerPanel.style.backgroundColor=n?"#000":"#fff",m.innerPanel.style.color=n?"#fff":"#000"}T(m.innerPanel.children[0],(n,o)=>{m.innerPanel.style.left=`${n}px`,m.innerPanel.style.top=`${o}px`}),T(m.innerPanel.children[m.innerPanel.children.length-1],(n,o)=>{let i=m.innerPanel.getBoundingClientRect();m.innerPanel.style.width=`${Math.max(200,n-i.x+32)}px`,m.innerPanel.style.height=`${Math.max(200,o-i.y+32)}px`});let e=m.innerPanel.querySelector("#vtbag-ui-opacity");m.innerPanel.style.opacity=`${parseInt(e.value,10)/100}`,e.addEventListener("input",n=>{m.innerPanel.style.opacity=`${parseInt(n.target.value,10)/100}`}),m.innerPanel.querySelector("#vtbag-ui-inner-panel-close").addEventListener("click",ct),m.mainPanel.querySelectorAll(":scope > div").forEach(n=>S(n))}function S(t){t.querySelector(":scope > h4")?.addEventListener("click",e=>{h(()=>{let n=e.target.closest("#vtbag-ui-panel > div");ut(),n?(m.pushBack=n.nextElementSibling,m.innerPanel.insertBefore(n,m.innerPanel.children[Y]),m.innerPanel.style.display="block"):m.innerPanel.style.display="none"},"inner panel")})}function lt(){let t=m.innerPanel.children[Y].id;(t==="vtbag-ui-slow-motion"||t==="vtbag-ui-control")&&(m.mainPanel.insertBefore(m.innerPanel.children[Y],m.pushBack??null),m.innerPanel.style.display="none")}function st(){top.setTimeout(()=>{let t=top.document.querySelector(`#vtbag-ui-inner-panel:has( > div:nth-of-type(${Y+1}):empty)`);t&&(t.style.display="none",ct())},100)}function ct(){dt(),h(()=>{ut(),m.innerPanel.style.display="none"},"close inner panel")}function ut(){m.innerPanel.children.length===te&&m.mainPanel.insertBefore(m.innerPanel.children[Y],m.pushBack??null),m.pushBack=null}function dt(){m??=top.__vtbag.inspectionChamber,m.mainPanel??=top.document.querySelector("#vtbag-ui-panel"),m.innerPanel??=top.document.querySelector("#vtbag-ui-inner-panel")}var mt=!0;function B(t){top.document.documentElement.dataset.vtbagModus=t||""}function y(){let t=top.document.documentElement.dataset.vtbagModus;return t||void 0}function It(t){let e=top.document.querySelector("#vtbag-ui-messages");e.innerHTML=ee[t],S(e);let n=top.document.querySelector("#vtbag-ui-modi");mt&&n.parentElement?.id==="vtbag-ui-panel"&&e.parentElement?.id==="vtbag-ui-panel"&&(mt=!1,top.document.querySelector("#vtbag-ui-panel")?.insertAdjacentElement("afterbegin",top.document.querySelector("#vtbag-ui-modi")));let o=top.document.querySelector("#vtbag-ui-panel #vtbag-ui-messages h4");o&&localStorage.getItem("vtbag-tutorial-mode")!=="false"&&o.click()}var ee={bypass:"<h4>How to Bypass</h4><p>Navigation is <b>not intercepted</b>.</p><ol><li>Optional: Examine elements by selecting from the View Transition Name list</li><li>Navigate your page as usual</li></ol>","slow-motion":"<h4>View in Slow Motion</h4><ol><li>Use the slider to set a <b>time stretch factor</b></li><li>Press a link on your page to start a view transition and study the <b>slowed down animations!</li></ol>","full-control":"<h4>Take Full Control</h4><ol><li>Start a transition</li><li>Optional: Select animations from the name list</li><li>Travel back and forth through the timeline of selected elements, check the single animations, hide old and new images or even animations to get a better view.</li><li>To end the inspection, click the [Exit] button in the Full Control panel or the <i>play indicator</i> ([>]) in the top left corner of the viewport.</li></ol>",compare:"<h4>Compare Side-by-side</h4><p>Sometimes you need a clear view of where you're coming from and where you're going!</p><p>Compare the <b>old and new pages side by side</b> and see what morphs where.</p>"};function L(t,e="",n=top.__vtbag.inspectionChamber.frameDocument,o=!1){let i="vtbag-adopted-sheet"+(e?"-"+e:"");n.getElementById(i)?.remove(),t&&n.head.insertAdjacentHTML(o?"afterbegin":"beforeend",`<style id="${i}">${t}</style>`)}function j(t,e){t?ie(e):ne()}function ne(){L("")}function ie(t=!1){L(`
	${t?`
* {
	pointer-events: none;
}
...
`),"image-visibility"),f()}function ge(t){let e=y()==="full-control"&&b(),n=top.document.querySelectorAll("#vtbag-ui-names li"),o,i=top.document.querySelector("#vtbag-ui-controller"),a=top.document.querySelector("#vtbag-ui-progress"),l=top.document.querySelector("#vtbag-ui-controller2"),d=top.document.querySelector("#vtbag-ui-progress2");n.forEach(c=>{c.innerText===t?(c.classList.contains("selected")?(l.value=i.value,d.innerText=a.innerText):(i.value=l.value,a.innerText=d.innerText),c.classList[e?"toggle":"add"]("selected"),o=c,c.style.display==="none"&&V()):e||c.classList.remove("selected")}),o&&o.scrollIntoView({behavior:"instant",block:"nearest",inline:"nearest"})}function le(t){let e=top.document.querySelector("#vtbag-ui-info");if(t&&!b())navigator.clipboard.writeText(`inspect(top.document.querySelector("#vtbag-main-frame").contentDocument.querySelector("${Nt(t)}"))`),e.innerHTML=`<h4>Info</h4>
      ...
      opacity: 1;
		...
		}`,"catch",void 0,!0)}async function Yt(){let t=top.__vtbag.inspectionChamber,e=t.frameDocument,n=t.animations=[],o=t.keyframesMap=new Map,i=new Set,a=new Set;t.styleMap=new Map;let l=new WeakSet,d=!0,c=!1,s=0;for(;d;)d=!1,e.getAnimations().forEach(r=>{if(l.has(r))return;l.add(r);let{pseudoName:p,viewTransitionName:I}=X(r),C=r instanceof CSSAnimation?z(r):r.id||=`vtbag-js-animation-${++s}`,v=r instanceof CSSTransition?r.transitionProperty:void 0;v?console.warn("[inspection-chamber] Unhandled transition:",I,p,v):C?(r.pause(),r.currentTime=0,I&&p==="image-pair"&&i.add(I),!I&&p==="::view-transition"&&(c=!0),!I&&a.add(C),C==="vtbag-twin-noop"?r.cancel():(n.push(r),o.set(C,r.effect?.getKeyframes()))):console.warn("[inspection-chamber] Unhandled animation:",I,p,r.constructor.name),d=!0}),d&&await new Promise(r=>e.defaultView.setTimeout(r)),c&&console.warn("[inspection-chamber] Root root animation detected");let g=r=>r.effect?.getComputedTiming().endTime?.valueOf()??0;n.length>0?(t.longestAnimation=n.reduce((r,p)=>g(r)===1/0||p.effect?.pseudoElement?.startsWith("::view-transition")&&g(p)>g(r)?p:r),t.animationEndTime=~~g(t.longestAnimation)):(t.longestAnimation=void 0,t.animationEndTime=0);let u=new Set,A=new Set;ht(e,e,i,u,A),U(u,A,new Set([...i,...a]))}function Ht(){let t=top.__vtbag.inspectionChamber;t.frameDocument.querySelector("#vtbag-adopted-sheet")?.remove(),t.animations?.forEach(n=>{try{n.effect?.getComputedTiming()?.iterations===1/0||n.finish()}catch(o){console.error(o,n,n.effect?.getComputedTiming())}})}function R(t,e,n){if(!e)return"";let o=e.split(/,(?![^(]*\))/).map(i=>`<td ${n?'colspan="'+n+'"':""}><tt><b>${i}</b></tt></td>`).join("");return e?`<tr><td style="text-align:right">${t}</td>${o}<tr>`:""}function J(t){let e=new Set,n=["offset","computedOffset","easing","composite"],o=top.__vtbag.inspectionChamber,i=o.styleMap,a=top.document.querySelector("#vtbag-ui-animations");a.innerHTML=b()?`<h4 data-vtbag-name=${t}>Animations of ${t}:</h4>`+l("group")+l("image-pair")+l("old")+l("new"):"",a.querySelectorAll('input[type="checkbox"]').forEach(s=>{let g=JSON.parse(s.dataset.vtbagContext);s.removeAttribute("data-vtbag-context"),s.checked=Ut(t,g.pseudo,g.idx,g.id)?.playState==="paused",s.addEventListener("change",()=>{ue(t,g.pseudo,g.idx,g.id,s.checked)||(s.checked=!s.checked)})}),a.querySelectorAll("[data-vtbag-snapshot]").forEach(s=>s.addEventListener("toggle",kt)),F(),kt(),S(a);function l(s){let g=[],u=i.get(`${s}-${t}`),A=u?.animation,r=z(u);if(e.clear(),r&&r!=="vtbag-twin-noop"&&r!=="none"){let I=r.split(", "),C=0;A.split(/,(?![^(]*\))/).forEach((v,w)=>{o.keyframesMap?.get(I[w])?g.push(`<details><summary><input type="checkbox" data-vtbag-context='{"pseudo":"${s}","idx":${w-C},"id":""}'/> ${s}: <tt>${I[w]}</tt></summary>${p(I[w],v.endsWith(r)?v.slice(0,-r.length):v)}</details>`):(g.push(`<span style="padding-right: 0.25ex; width: 4.75ex; display: inline-block; text-align:right">\u26A0\uFE0F</span> ${s}: error in animation: <tt>${v}</tt>.<br>`),++C)})}return o.animations?.filter(I=>!("animationName"in I)&&I.effect?.pseudoElement===`::view-transition-${s}(${t})`).forEach((I,C)=>{let v=w=>{let E=w.effect?.getTiming();return`${E?.duration||"0"}ms ${E?.easing??""}  ${E?.delay??"0"}ms   ${E?.iterations??""} ${E?.direction??""} ${E?.fill??""} ${w.playState}`};g.push(`<details><summary><input type="checkbox" data-vtbag-context='{"pseudo":"${s}","idx":-1,"id":"${I.id}"}'/> ${s}: <tt>${I.id}</tt></summary>${p(I.id,v(I))}</details>`)}),e.size>0&&g.push(`<details data-vtbag-live-values="${s+","+[...e].sort().join(",")}"><summary>&nbsp;\u{1F300}&thinsp; ${s}: live values</summary></details>`),u&&g.push(`<details data-vtbag-snapshot="${s}"><summary>&nbsp;\u{1F4F8} ${s}: CSS snapshot</summary></details>`),g.length>0?g.join("")+"<hr>":"";function p(I,C){let v=d(I)||"\u26A0\uFE0F no properties? ";return`
<table>
	${R("animation:",C,"4")}
	${R("animates:",v)}
	${c(I)}
</table>`}}function d(s){let g=new Set;o.keyframesMap?.get(s)?.forEach(A=>Object.keys(A).forEach(r=>g.add(r)));let u=[...g].filter(A=>!n.includes(A)).sort();return u.forEach(A=>e.add(A)),u.join(", ")}function c(s){return o.keyframesMap?.get(s)?.map(g=>R(+(g.computedOffset??0)*100+"% :",Object.keys(g).sort().filter(u=>!n.includes(u)).map(u=>g[u]).join(", "))).join("")}}function xt(){top.__vtbag.inspectionChamber.animations?.forEach(t=>{t instanceof CSSAnimation&&z(t)!=="vtbag-twin-noop"&&t.playState==="idle"&&t.pause()}),J(top.document.querySelector("#vtbag-ui-animations h4").dataset.vtbagName),f()}function ue(t,e,n,o,i){let a=Ut(t,e,n,o);return a?(i?(a.pause(),y()==="full-control"&&f()):a.cancel(),!0):!1}function Ut(t,e,n,o){let i=`::view-transition-${e}(${t})`,a=top.__vtbag.inspectionChamber,l=a.animations;if(o){let u=l.filter(A=>A.id===o&&A.effect?.pseudoElement===i);if(u.length===1)return u[0];console.error(`[injection chamber] found ${u.length} animations for ${i} when looking for animation with id ${o} `);return}let d=a.styleMap,c=z(d.get(`${e}-${t}`)).split(", ")[n],s=l.filter(u=>u.effect?.pseudoElement===i);if(n>=s.length){console.error(`[injection chamber] found ${s.length} animations for ${i} when looking for animation with index ${n} called ${t}`);return}let g=s[n];if(g instanceof CSSAnimation&&z(g)!==c){console.error(`[injection chamber] found an animation called ${z(g)} for ${i} when looking for animation at index ${n} with expected name ${t}`);return}return g}function F(){let t=top.document.querySelector("h4[data-vtbag-name]")?.dataset.vtbagName,n=top.__vtbag.inspectionChamber.styleMap;top.document.querySelectorAll("[data-vtbag-live-values]").forEach(o=>{let[i,...a]=o.dataset.vtbagLiveValues.split(","),l=n.get(`${i}-${t}`),d=a.map(c=>R(c+":",l.getPropertyValue(c)));o.innerHTML=`<summary>&nbsp;\u{1F300}&thinsp; ${i}: live values</summary><table>`+d.join("")+"</table>"})}function kt(){let t=top.document.querySelector("h4[data-vtbag-name]")?.dataset.vtbagName,n=top.__vtbag.inspectionChamber.styleMap;top.document.querySelectorAll("[data-vtbag-snapshot]").forEach(o=>{if(o.open){let i=o.dataset.vtbagSnapshot,a=o.previousElementSibling?.dataset.vtbagLiveValues?.split(",").slice(1)??[""],l=n.get(`${i}-${t}`),d=yt(l).filter(c=>!a.includes(c)).sort().map(c=>R(c+":",l.getPropertyValue(c)));o.innerHTML=`<summary>&nbsp;\u{1F4F8} ${i}: CSS snapshot</summary><table>`+d.join("")+"</table>"}})}function z(t){let e=t?.animationName;return e&&e.startsWith('"')&&(e=e.split(/\s*,\s*/).map(n=>n.slice(1,-1)).join(", ")),e}function Rt(){let t=top.__vtbag.inspectionChamber.animationEndTime;top.document.querySelector("#vtbag-ui-controller-max").innerText=t+" ms",top.document.querySelector("#vtbag-ui-progress").innerText="0";let e=top.document.querySelector("#vtbag-ui-controller");e.max=""+t,e.value="0",e.disabled=!1,top.document.querySelector("#vtbag-ui-progress2").innerText="0";let n=top.document.querySelector("#vtbag-ui-controller2");n.max=""+t,n.value="0",n.disabled=!1,f(),q()}function f(){let t=top.__vtbag.inspectionChamber,e=t.animations;if(t.updateNameVisibilityTimeout&&(top.clearTimeout(t.updateNameVisibilityTimeout),t.updateNameVisibilityTimeout=void 0),t.updateNameVisibilityTimeout=top.setTimeout(q,jt),e){let n=parseInt(top.document.querySelector("#vtbag-ui-progress").innerText,10),o=parseInt(top.document.querySelector("#vtbag-ui-progress2").innerText,10),i=new Set;top.document.querySelectorAll("#vtbag-ui-names li.selected").forEach(a=>i.add(a.innerText)),e.forEach(a=>{if(a.playState==="paused"){let{viewTransitionName:l}=X(a);a.currentTime=l&&i.has(l)?n:o}})}F()}function X(t){let e=t.effect?.pseudoElement?.replace(/::view-transition-(new|old|group|image-pair)\((.*)\)/,"$1 $2").split(" ");return{pseudoName:e?.[0],viewTransitionName:e?.[1]}}function Wt(){let t=top.document.querySelector("#vtbag-ui-controller"),e=top.document.querySelector("#vtbag-ui-progress");t.addEventListener("input",i=>{i.target instanceof HTMLInputElement&&(e.innerText=""+~~i.target.value,f())});let n=top.document.querySelector("#vtbag-ui-controller2"),o=top.document.querySelector("#vtbag-ui-progress2");n.addEventListener("input",i=>{i.target instanceof HTMLInputElement&&(o.innerText=""+~~i.target.value,f())})}function Q(){b()&&y()==="full-control"&&f()}var Ot="vtbag-ui-panel-orientation",Vt="vtbag-ui-framed",Qt="named_only",Gt="\u{1F52C}";top.__vtbag??={};top.__vtbag.inspectionChamber??={};var M=top.__vtbag.inspectionChamber;top===self?top.setTimeout(Ae,500):self.parent===top&&de();function de(){let t=M.frameDocument=self.document;self.addEventListener("pageswap",K),self.addEventListener("pagereveal",me),e();function e(){let n=top.document.startViewTransition;if(!n)return;let o=i=>async()=>{await Promise.resolve(),i&&await i(),Bt()};CSS.supports("selector(:active-view-transition-type(x))")?t.startViewTransition=i=>{let a={types:[],update:void 0};return K(),!i||i instanceof Function?a.update=o(i):(a.types=i.types,a.update=o(i.update)),M.viewTransition=n.call(t,a)}:t.startViewTransition=i=>{"@vtbag";return K(),M.viewTransition=n.call(t,o(i))}}}function K(){!1,M.glow?.cancel(),j(!1,!1)}function me(t){M.viewTransition="viewTransition"in t&&t.viewTransition||void 0,Bt()}function Bt(){!1,M.viewTransition&&(Zt(),Ie())}function Ie(){at();let t=top.document.documentElement,e=M.viewTransition,n={bypass:()=>{},"slow-motion":pt,"full-control":Rt,compare:()=>{}},o=y();e.updateCallbackDone.catch(()=>{}),e.ready.then(async()=>{if(o&&o!=="bypass"){try{await Yt(),j(!!top.document.querySelector("#vtbag-ui-framed")?.checked,!!top.document.querySelector("#vtbag-ui-named-only")?.checked),M.twin?.ownerDocument.addEventListener("click",wt)}finally{}n[o]()}top.history.replaceState(self.history.state,"",self.location.href),top.document.title=Gt+" "+self.document.title}).finally(()=>{}),e.finished.finally(()=>{rt(),M.viewTransition=void 0,M.frameDocument?.querySelector("#vtbag-twin--view-transition")?.remove(),Ht(),M.animations=void 0,M.longestAnimation=void 0,j(!!top.document.querySelector("#vtbag-ui-framed")?.checked,!!top.document.querySelector("#vtbag-ui-named-only")?.checked),U(G()),x(),top.document.querySelector("#vtbag-ui-slo-mo-progress").innerText="",top.document.querySelector("#vtbag-ui-animations").innerText="",!y()&&top.document.querySelector("#vtbag-ui-modi li input")?.click(),M.frameDocument.addEventListener("click",Jt),st()})}function qt(){let t=top.document.documentElement;t.style.setProperty("--vtbag-background-accent",t.style.colorScheme.startsWith("dark")?"#4E545D":"#c6d1d7")}function pe(){let t=top.document.querySelector("#vtbag-tutorial-mode");t.checked=localStorage.getItem("vtbag-tutorial-mode")!=="false",t.addEventListener("change",()=>{localStorage.setItem("vtbag-tutorial-mode",""+t.checked);let e=top.document.querySelector("#vtbag-ui-inner-panel #vtbag-ui-messages h4"),n=top.document.querySelector("#vtbag-ui-panel #vtbag-ui-messages h4");!t.checked&&e&&e.click(),t.checked&&n&&n.click()})}async function Ae(){if(top.document.querySelector("#vtbag-ui-panel"))return;let t=top.document.documentElement;if(top.sessionStorage.getItem(k)==="true"){ot();return}let e=top.getComputedStyle(t).colorScheme,n=top.document.title,o=top.document.querySelector('link[rel="icon"]')?.outerHTML??"",i=_.replace('<iframe id="vtbag-main-frame" src="/"></iframe>',`<iframe id="vtbag-main-frame" style="opacity: 0;" src="${location.href}"></iframe>`).replace("<title></title>",`<title>${Gt} ${n}</title>`).replace('<link rel="icon" />',o);top.addEventListener("resize",Pt),t.innerHTML=i,t.style.colorScheme=e,Pt(),qt(),pe(),B();let a=top.document.querySelector("#vtbag-main-frame");if(await new Promise(d=>a.onload=d),!top.document.startViewTransition){top.document.querySelector("#vtbag-ui-messages").innerHTML=`
			...
			<p>Sadly have to give up.</p>`,top.document.querySelectorAll("#vtbag-ui-modi, #vtbag-ui-filter, #vtbag-ui-names, #vtbag-ui-animations, #vtbag-ui-info").forEach(d=>d.remove());return}U(G()),ve();let l=top.document.querySelector("#divider");T(l,(d,c)=>{t.classList.contains("vtbag-ui-column")?t.classList.contains("vtbag-ui-tl")?t.style.setProperty("--vtbag-panel-width",`calc(max(216px, ${Math.min(innerWidth-100,d)}px))`):t.style.setProperty("--vtbag-panel-width",`calc(max(216px, 100vw - ${Math.max(100,d+1)}px))`):t.classList.contains("vtbag-ui-tl")?t.style.setProperty("--vtbag-panel-height",`calc(max(245px, ${Math.min(innerHeight-100,c)}px))`):t.style.setProperty("--vtbag-panel-height",`calc(max(245px, 100vh - ${Math.max(100,c+1)}px))`)}),localStorage.getItem("vtbag-tutorial-mode")!=="false"&&top.document.querySelector("#vtbag-ui-messages h4").click(),a.animate([{opacity:0,transform:"translateY(100vh)"},{opacity:1}],{duration:500,fill:"forwards"}),a.contentDocument.addEventListener("click",Jt)}function Jt(t){if(b())return;let n=t.target.closest("[data-vtbag-transition-name]");if(n){let o=n.dataset.vtbagTransitionName;top.document.querySelectorAll("#vtbag-ui-names li").forEach(i=>{i.innerText===o&&(i.click(),t.ctrlKey&&t.shiftKey&&t.preventDefault())})}}function Pt(){let t=top.document.documentElement,e=top.localStorage.getItem(Ot)??"";e?(e.split(" ").forEach(n=>t.classList.add(n)),Xt()):Ft()}function Ft(){h(()=>{let t=top.document.documentElement.classList;Z(),t.toggle("vtbag-ui-column"),t.contains("vtbag-ui-column")&&t.toggle("vtbag-ui-tl"),top.localStorage.setItem(Ot,[...t].filter(e=>e.startsWith("vtbag-ui-")).join(" ")),Xt()},"switch orientation")}function Xt(){let t=top.document.querySelector("#vtbag-ui-turn"),e=top.document.documentElement.classList;t.innerText="\u292A\u2928\u2929\u2927"[(e.contains("vtbag-ui-column")?2:0)+(e.contains("vtbag-ui-tl")?1:0)]}function ve(){top.document.querySelector("#vtbag-ui-turn").addEventListener("click",()=>Ft()),top.document.querySelector("#vtbag-ui-light-dark").addEventListener("click",()=>{let i=top.document.documentElement.style;top.document.querySelector("#vtbag-main-frame").contentDocument.documentElement.style.colorScheme=i.colorScheme=i.colorScheme.startsWith("dark")?"light":"dark",qt()}),gt(),top.document.querySelector("#vtbag-ui-standby").addEventListener("click",()=>{top.sessionStorage.setItem(k,"true"),top.location.reload()}),top.document.querySelector("#vtbag-ui-modi ul").addEventListener("change",Ce),St(),zt();let e=top.document.querySelector("#vtbag-ui-framed"),n=top.document.querySelector("#vtbag-ui-named-only");e.addEventListener("change",o),n.addEventListener("change",o);function o(){let i=e.checked,a=n.checked;top.sessionStorage.setItem(Vt,i?"X":""),top.sessionStorage.setItem(Qt,a?"X":""),j(i,a)}vt(),Wt(),top.document.querySelectorAll("#vtbag-ui-control-exit, #vtbag-ui-control-play").forEach(i=>i.addEventListener("click",Z)),top.addEventListener("keyup",function(i){i.key==="Escape"&&(b()?Z():(top.sessionStorage.setItem(k,"true"),top.location.reload()))})}function Ce(){let t=top.document.querySelector("#vtbag-ui-modi ul input:checked");if(t){let e=t.id.replace("vtbag-m-","");e!==y()&&h(()=>{B(e),Z(),top.document.querySelector("#vtbag-ui-filter ul input").click(),e==="slow-motion"&&$("#vtbag-ui-slow-motion"),e==="full-control"&&$("#vtbag-ui-control"),e==="bypass"&&$("#vtbag-ui-modi"),It(e),lt()},"update-modus")}}function $(t){let e=top.document.querySelector("#vtbag-ui-framed"),n=top.document.querySelector("#vtbag-ui-named-only"),o=e.parentElement,i=top.document.querySelector(t);e.checked=!!top.sessionStorage.getItem(Vt),n.checked=!!top.sessionStorage.getItem(Qt),j(e.checked,n.checked),o&&i&&o.parentElement!==i&&i.insertAdjacentElement("beforeend",o)}})();
